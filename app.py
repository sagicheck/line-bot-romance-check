...
# あなたのLINEチャネルアクセストークンとシークレットをここに入れてください
...
def handle_message(event):
    ...
    if any(keyword in message for keyword in ["渡航費", "マッチングアプリ", "外国人", "会ったことがない", "手術費"]):
        reply_text = (
            ...
            "あなたが悪いわけではありません。信じる心を利用する詐欺が悪いのです。\n\n"
            "私たちは、あなたが後悔しないようにお手伝いしたいと願っています。"
        )
    else:
        reply_text = "ありがとうございます。該当の内容について、もう少し詳しく教えていただけますか？"
